...
class EditarCampaniaUseCaseTest {
    ...
    fun `invoke with valid data updates and emits success`() = runTest {
        val campania = Campania(id = 1, nombre = "Nueva", cultivo = "Soja", fechaInicio = 1L, estaActiva = true)
    ...
    fun `invoke with blank name emits error`() = runTest {
        val campania = Campania(id = 1, nombre = "  ", cultivo = "Soja", fechaInicio = 1L, estaActiva = true)
