...
- Se modificó ObtenerResumenRendimientoUseCase para procesar los ingresos calculando precio por cantidad de CosechaNoAlmacenada (tipo Venta).
...
- Se creó ObtenerResumenRendimientoUseCaseTest para validar las reglas matemáticas en la capa de Domain.
