...
**[2026-08-21] - Fix Inserci�n de Insumos al Cat�logo [#334]**
- Se corrigi� un error donde FormularioInsumoViewModel le�a un insumoId = -1 por defecto y causaba que se ejecutara el flujo de actualizaci�n silenciosamente en lugar de crear uno nuevo.

**[2026-08-21] - Fix Edici�n de Cosechas [#335]**
- Se agreg� el par�metro cosechaId a la ruta de navegaci�n de FormularioCosecha y se vincul� el evento onEditarCosecha para permitir la edici�n correcta de las cosechas.

**[2026-08-21] - Fix Validaci�n de Formulario de Cosechas [#336]**
- Se a�adi� una propiedad errorGeneral para evitar que todos los errores del formulario de cosecha se agruparan err�neamente en el campo cantidad, mostrando en cambio un Snackbar universal.
**[2026-08-21] - Fix Reportes Exportaci�n vac�a y Comparador [#355] [#356]**
- Se agreg� una guardia en ReportesViewModel para evitar exportar PDFs o CSVs vac�os cuando no hay datos en la campa�a seleccionada.
- Se implement� una tarjeta de advertencia en ReportesRendimientoScreen para prevenir que el usuario seleccione la misma campa�a en ambos selectores del comparador, documentando el caso en el plan de pruebas.
**[2026-08-21] - Fix UI Detalles y Reportes [#339] [#340]**
- Se migr� el TabRow a ScrollableTabRow en DetalleCampaniaScreen para evitar que los nombres de las pesta�as se corten o dividan en varias l�neas.
- Se ocult� la leyenda por defecto de los gr�ficos PieChart en ReportesRendimientoScreen y se cre� una leyenda manual debajo utilizando FlowRow, solucionando el problema de solapamiento de etiquetas en el gr�fico.
