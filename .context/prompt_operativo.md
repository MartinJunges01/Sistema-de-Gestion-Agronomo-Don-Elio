...
1.  **Roadmap:** Actualiza el roadmap activo correspondiente (actualmente `.context/roadmap_iteracion_6.md`) marcando el checkbox correspondiente con `[x]`. (Los archivos de iteraciones anteriores sirven como histórico).
...
**Acción:** 
1. Antes de iniciar una tarea, revisa la lista actual en el roadmap activo (actualmente `.context/roadmap_iteracion_6.md`).
