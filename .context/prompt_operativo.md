...
- **Bloque 1: Módulo de Reportes y Exportación (Desarrollador 1 - MartinJunges01)**
  - **Responsabilidad exclusiva:** La carpeta eportes/ (UI y ViewModels) y la clase ReportExporter. Ningún otro desarrollador o agente tiene permitido tocar estos archivos.
