...
**VM-C-S1: campaniaId expl�cito en SavedState no se sobreescribe por el manager**
...
**VM-C-S2: sin campaniaId en SavedState el manager act�a como fallback**
...
* **Dado** el ViewModel inicia sin campaniaId v�lido.
* **Cuando** se observa isCampaniaValid.
* **Entonces** isCampaniaValid = false.

**VM-C-S6: isCampaniaValid emite true tras sincronizarCampania con id v�lido**
* **Dado** el ViewModel inicia sin campaniaId.
...
**VM-T-S1: campaniaId expl�cito en SavedState no se sobreescribe por el manager**
* **Dado** el ViewModel se crea con campaniaId = 5 en SavedStateHandle.
* **Cuando** el UltimaSeleccionManager emite id = 3.
* **Entonces** filtroCampania permanece en 5.

**VM-T-S2: sin campaniaId en SavedState el manager act�a como fallback**
* **Dado** el ViewModel se crea sin campaniaId en SavedStateHandle.
* **Cuando** el UltimaSeleccionManager emite id = 7.
...
* **Cuando** se llama a formatearMoneda(-6133500.0).
* **Entonces** devuelve "-`$`6,1M" con el signo al frente (no al final como har�a NumberFormat de locale es_AR).
...
* **Dado** un InsumoVinculacionViewModel con una campa�a seleccionada (campaniaId).
...
**DC-1: El men� de Detalle de Campa�a muestra todas las tareas**
* **Dado** una campa�a con 1 tarea pendiente y 1 completada.
* **Cuando** se visualiza el CardModuloTareas.
* **Entonces** dice "1 pendientes" y "1 completadas" (antes dec�a 0 completadas).

**DC-2: El men� de Detalle de Campa�a muestra todas las cosechas**
* **Dado** una campa�a con 1 cosecha almacenada de 5 Tn y 1 venta de 2 Tn.
...
**DR-3: El c�lculo de ingresos detecta precio mayor a 0 en lugar de la palabra "venta"**
