...
**Test UC-V1: ValidarDatosCampaniaUseCase ÃƒÂ¢Ã‚Â€Ã‚Â” Nombre vacío**
...
**Test UC-V2: ValidarDatosCampaniaUseCase ÃƒÂ¢Ã‚Â€Ã‚Â” Fecha pasada en creación**
...
**Test UC-V3: ValidarDatosCampaniaUseCase ÃƒÂ¢Ã‚Â€Ã‚Â” Fecha pasada permitida en edición**
*   **Given:** nombre = "Campaña", cultivo = "Maíz", fechaInicio = <ayer en millis>, isEditMode = true
*   **When:** invoke(...)
*   **Then:** esValido = true, errorFecha = null

**Test UC-V4: ValidarDatosCampaniaUseCase ÃƒÂ¢Ã‚Â€Ã‚Â” Todos los campos válidos**
...
**Test UC-V5: ValidarInsumoUseCase ÃƒÂ¢Ã‚Â€Ã‚Â” Categoría vacía**
...
**Test UC-V6: ValidarInsumoUseCase ÃƒÂ¢Ã‚Â€Ã‚Â” Ambos campos válidos**
...
*   **Cosechas (Formulario):** Guardar sin campaña seleccionada (Issue 7) ÃƒÂ¢Ã‚Â€Ã‚Â” Debe emitir `errorCampania` y NO crashear por FK constraint; guardar con `cantidad` o `unidad` vacías (Issue 12) ÃƒÂ¢Ã‚Â€Ã‚Â” Debe emitir el error visual correspondiente y deshabilitar el botón "Guardar".
...
**ÃƒÂ‚Ã‚¿Qué hace automáticamente?**
...
#### ReportesViewModel ÃƒÂ¢Ã‚Â€Ã‚Â” guardia de exportación [#300]
...
#### ReportesViewModel ÃƒÂ¢Ã‚Â€Ã‚Â” comparación real entre campañas [#302]
